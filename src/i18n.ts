...
export const translations: Record<Lang, Dict> = {
  ...
  de: {
    ...
    verify: {
      title: "SMS-Verifizierung pro Dienst",
      subtitle: "Brauchst du nur den Code eines bestimmten Dienstes? Hol ihn dir für 0,50€ sofort",
      badge: "0,50€ pro Verifizierung",
      perService: "pro Verifizierung",
      buyBtn: "Verifizierung kaufen",
      selectCountry: "Wähle dein Land",
      allCountries: "Alle Länder",
      searchCountry: "Land suchen...",
      selectService: "Wähle den Dienst, den du verifizieren möchtest",
      instantCode: "Sofortiger Code",
      privateAccess: "Privater Zugang",
      noRegistration: "Ohne Registrierung",
      howItWorks: "Wie es funktioniert",
      step1: "Wähle den Dienst (Telegram, WhatsApp, Google...) und zahle 0,50€",
      step2: "Erhalte deinen privaten Zugangslink ohne Registrierung",
      step3: "Nutze unsere Nummer beim Dienst und erhalte den Code sofort",
      modalTitle: "SMS-Verifizierung",
      modalSubtitle: "Erhalte den Code eines bestimmten Dienstes für nur 0,50€",
      yourEmail: "Deine E-Mail (optional, um deinen Link zu erhalten)",
      emailOptional: "Optional / Ohne Registrierung",
      payBtn: "0,50€ mit CoinPayments zahlen",
      processing: "Zahlung wird verarbeitet...",
      successTitle: "Deine Verifizierung ist bereit!",
      successSub: "Wir haben deinen privaten Link erstellt. Nutze ihn, um deinen Code zu sehen, wenn die SMS ankommt.",
      yourLink: "Dein privater Zugangslink:",
      copyLink: "Link kopieren",
      copied: "Kopiert!",
      goToVerify: "Meine Verifizierung jetzt ansehen",
      saveLinkWarn: "Wichtig: Speichere diesen Link. Ohne ihn kannst du deinen Code nicht sehen. Er kann nicht wiederhergestellt werden.",
      waitingTitle: "Warten auf deinen SMS-Code...",
      waitingSub: "Nutze die Nummer unten beim gewählten Dienst. Der Code erscheint hier automatisch.",
      codeReceived: "Code erhalten!",
      codeLabel: "Dein Verifizierungscode:",
      copyCode: "Code kopieren",
      noCodeYet: "Noch kein Code erhalten",
      noCodeDesc: "Nachrichten erscheinen hier automatisch beim Empfang.",
      ...
      invalidLinkDesc: "Dieser Link entspricht keiner aktiven Verifizierung. Überprüfe, ob du ihn richtig kopiert hast.",
      service: "Dienst",
      price: "Preis",
      status: "Status",
      statusWaiting: "Wartet auf SMS",
